CC=gcc
CFLAGS=-I./inc/ -I./ascon-c-1.3.0/crypto_hash/asconxofv13/armv7m/ -I./asconc-c-1.3.0/crypto_aead/ascon128abi32v13/bi32/ -g -Wall -Bstatic

all: secure.o send.o recieve.o hash.o;
	# Inlude assembly 32 bit int optimized ascon encryption
	ar rcs build/libbloat.a build/secure.o build/send.o build/recieve.o build/hash.o ascon-c-1.3.0/build/libcrypto_aead_asconabi32v13_bi32.a ascon-c-1.3.0/build/libcrypto_hash_asconxofv13_ref.a
...
test-build: main.o;
	${CC} ${CFLAGS} -L./build/ -L./ascon-c-1.3.0/build/ -lbloat -lcrypto_aead_asconabi32v13_bi32 ./test/build/main.o -o ./test/build/test
